...
public class Constants {
    ...
    public static String pf_baseUrl = "https://sso.likemindscloud.com:9035";
    ...
    public static String issuer = "https://sso.likemindscloud.com";
    public static String clientId = "j2ee_oidc_client";
